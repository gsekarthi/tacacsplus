...
public class Header {
    ...
    static byte[] crypt(byte versionNumber, byte sequenceNumber, 
            byte[] body, byte headerFlags, byte[] sessionID, byte[] secretkey) throws IOException, NoSuchAlgorithmException {
    ...
    static byte[] makeHeader(byte[] body, Byte version, byte type, Integer tacacsSequence,
